#!/usr/bin/env python
"""
Aquila Configuration File
Created: 2016 Jan 08
Author: James Quen

Description:
Configuration file for the Aquila project.
"""
...
if not MFG_DB_STAGING:
      MATCHSTR_INTERNAL_REGEX = 'C.ZZ[^BOSI]{5}'        
      MATCHSTR_REGEX = 'C.[^Z]Z[^BOSI]{5}'
else:
      MATCHSTR_INTERNAL_REGEX = 'C.ZZ.{5}'        
      MATCHSTR_REGEX = 'C.[^Z]Z.{5}' 

#========================================================================================
# TEST LIMITS
#========================================================================================
MCU_CURRENT_LOWER = 0.0028          # equals 3.8 milliamps
MCU_CURRENT_UPPER = 0.0035          # equals 4.9 milliamps
IDLE_CURRENT_LOWER  = 0.00000275      # equals 2.75 microamps
IDLE_CURRENT_UPPER  = 0.000007      # equals 7 microamps - raised to account for watchdog and 32khz clock
LED_CURRENT_LOWER  = 0.0055         # equals 8.5 milliamps
LED_CURRENT_UPPER  = 0.0067         # equals 11.2 milliamps
LOAD_CURRENT_LOWER  = 0.0020        # equals 5.0 milliamps
LOAD_CURRENT_UPPER  = 0.0025        # equals 6.2 milliamps
ACCEL_CURRENT_LOWER = 0.000003      # equals 13 microamps
ACCEL_CURRENT_UPPER = 0.000010      # equals 19 microamps
DEEP_SLEEP_CURRENT_LOWER  = 0.0000002     # equals 0.1 microamps
DEEP_SLEEP_CURRENT_UPPER  = 0.0000007     # equals 1.0 microamps
Z_DATA_THRESHOLD_LOWER = 435        # accelerometer reading
Z_DATA_THRESHOLD_UPPER = 600        # accelerometer reading
RSSI_LOWER = -75
RSSI_UPPER = -30
OPER_CURR_THRESH_LOWER = 0.000003     # equals 6 microamps
OPER_CURR_THRESH_UPPER = 0.000007     # equals 18 microamps
